...
// // // //  3.arithmatic operations on two number.
...
// for:
// 1.write a js code to print numbers from 1 to 16
// console.log(" 1.write a js code to print numbers from 1 to 16");
// console.log("print numbers from 1 to 16 ");
// for(let j=1;j<=16;j++){
//     console.log(j);
// }
...
// // console.log("print the power of 1 to 20 ");
// for(let x=1;x<=20;x++){
//     // if(x==4){
...
// console.log("print Even number 1 to 20");
