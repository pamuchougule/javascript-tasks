...
// let friends=["abhinandan","prathamesh","omkar","sameer","niranjan"];
// console.log(friends);
// let newfriends=friends.push("abhishek");
// console.log(friends);
...
// let friend=["abhinandan","prathamesh","omkar","sameer","niranjan"];
// console.log(friend);
...
// // eg.2
// let  favfruits=[ "almond","banana","cherry","orange","mango","lemon"];
...
// let besties=["abhinandan","prathamesh","omkar","sameer"];
// console.log(besties);
// let newBesties=["sanket","gaurav","pradip"];
...
// let subject=["marathi","hindi","english","Science","geoghaphy"];
// console.log(subject);
...
// // 3) fill
// // eg .1
// let Name=["abhinandan","prathamesh","omkar","sameer"];
// console.log(Name);
// console.log(Name.fill("sairaj"));

// // eg .2
// let bestFriend=["abhinandan","prathamesh","omkar","sameer"];
// console.log(bestFriend);
// console.log(Name.fill("pravin"));
// console.log(" ");
...
// let stringValue=["abhinandan","prathamesh","omkar","sameer"];
// console.log(stringValue);
// console.log(stringValue.sort());

// // eg 2
// let className=["abhinandan","prathamesh","omkar","sameer","abhi","pravin"];
...
// let stringValues=["abhinandan","prathamesh","omkar","sameer","abhishek"];
...
// // eg 2
// let classNames=["abhinandan","prathamesh","omkar","sameer","abhishek"];
...
// // 3) include
// // eg 1
// let food=["chapati","roti","chikan","bhaji"];
// console.log(food);
// console.log(food.includes("roti"));

// // eg 2
// console.log(food.includes("pavbhaji"));
// console.log(" ");
...
// let myNames=Array.of("abhinandan","prathamesh","omkar",);
// console.log(myNames);
...
// console.log(Array.isArray(["abhinandan","prathamesh","omkar"]));
...
// const mymobile=mobile.filter((mobile)=>{
//     //   console.log(mobile);
//          if(mobile.brand === "mi"){
//              return true ;
//          }
